...
class FeedbackController extends Controller {
  ...
  #verifyUserPermission = async (feedbackId, userId) => {
    ...
    if (feedbackOwner.toString() !== userId.toString())
      throw new Error("User is not owner of feedback");
  };
  ...
  async delete({ response, params }) {
    try {
      ...
      if (deletedFeedback.imagePath)
        this.#deleteImage(deletedFeedback.imagePath);
